...
import SimpleForm from '../src/React-Redux/Components/SimpleForm';
import ListForm from '../src/React-Redux/Components/ListForm';
import EditSimpleForm from './React-Redux/Components/EditSimpleForm';
      ...
      <BrowserRouter>
        <Main>
          <Switch>
            ...
            <Route exact path="/list-form"> <ListForm /></Route>
            <Route path="/list-form/edit-form/:id"> <EditSimpleForm /></Route>
            <Route path="/simple-form"><SimpleForm /></Route>
          </Switch>
        </Main>
      </BrowserRouter>
    </div>
